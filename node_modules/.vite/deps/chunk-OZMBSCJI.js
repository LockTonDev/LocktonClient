...
var VTimelineItem = genericComponent()({
  ...
  setup(props, _ref) {
    ...
    watch(dotRef, (newValue) => {
      ...
      if (!newValue)
        return;
      dotSize.value = (_b = (_a = newValue.$el.querySelector(".v-timeline-divider__dot")) == null ? void 0 : _a.getBoundingClientRect().width) != null ? _b : 0;
    }, {
      flush: "post"
    });
    useRender(() => {
...
//# sourceMappingURL=chunk-OZMBSCJI.js.map
