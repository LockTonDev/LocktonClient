        ...
        <v-col cols="12" sm="9" class="px-0 mt-12">
          ...
          <ul :class="checkMobile.isMobile?'list-style-type-none v-box py-2 px-2 mt-10 border-color-gray':'list-style-type-none v-box py-2 px-16 mt-10 border-color-gray'">
            ...
            <li class="d-flex justify-space-between align-center py-8">
              ...
              <p :class="checkMobile.isMobile?'text-h6 w-30 ml-4 mr-2':'text-h6 w-30 ml-10'">2010년부터 단체보험 운영</p>
              <div class="text-body-1 line-1-6 w-50">
                <p>2010년부터 단체보험 도입</p>
                ...
                <v-dialog persistent v-model="isDialogFAQ" activator="parent" scrollable max-width="1000">
                  ...
                  <v-card>
                    ...
                    <v-card-text class="pa-0">
                      <iframe src="/assets/doc/LAW/2023 예상질문에 대한 답변서.pdf" width="100%" height="800px"></iframe>
                    </v-card-text>
                  </v-card>
                </v-dialog>
              </v-btn>
                      ...
                      <v-card-text class="px-10 py-6 text-16">
                        ...
                        <table class="normal-table mt-6">
                          ...
                          <tbody>
                            <tr>
                              <th>담보업무</th>
                              <td class="border-right-0">과거 보험기간에 수행한 법무사의 업무</td>
                            </tr>
                            <tr>
              ...
              <table class="normal-table mt-6">
                ...
                <tr>
                  ...
                  <td class="border-right-0">
                    ...
                    - 각 지방 법무사회에 사무원으로 등록된 전 직원의 일괄가입이 조건임 <br/>(법무사 유자격자 제외)
                  </td>
                </tr>
                <tr>
                  ...
                  <td class="border-right-0">
                    ...
                    <a class="v-btn v-btn--flat text-primary rounded-md v-btn--variant-outlined mt-2 px-4 py-1 text-14" href="/assets/doc/LAW/법무사_사고통보서.pdf" download>
          ...
          <table class="normal-table">
            ...
            <tbody>
              <tr>
                ...
                <td colspan="2" class="border-right-0">대한법무사협회 회원만 가입 가능</td>
              </tr>
              <tr>
                <td>개인 가입</td>
                <td class="border-right-0">개인사무소에 등록법무사가 근무하는 경우 별도로 가입 해야함</td>
              </tr>
              <tr>
                <td>소속 법무사의 복수 가입<br/>(보상한도 공유가입)</td>
                <td class="border-right-0">소속 법무사가 보상한도를 공유하여 가입되며, <br/>3명 이상 복수 가입시 연간총보상한도액 2배수 적용</td>
              </tr>
              <tr>
                <td>보상한도 증액</td>
        ...
        <v-col cols="11" sm="11">
          ...
          <ul :class="checkMobile.isMobile?'list-style-type-none v-box py-10 mt-10 border-color-gray bg-lightbackground px-2 text-16 word-break-keep-all': 'list-style-type-none v-box py-10 mt-10 border-color-gray bg-lightbackground px-16 text-16 word-break-keep-all'">
            <li :class="checkMobile.isMobile?'d-flex align-center px-2':'d-flex align-center px-16'">
              ...
              <dl :class="checkMobile.isMobile?'ml-4':'ml-16'">
                ...
                <dd class="mt-2">
                  <a class="v-btn v-btn--flat text-primary rounded-md v-btn--variant-outlined mr-4 px-4 py-1 text-14" href="/assets/doc/LAW/법무사_사고통보서.pdf" download>
            ...
            <li :class="checkMobile.isMobile?'d-flex align-center px-2':'d-flex align-center px-16'">
              ...
              <dl :class="checkMobile.isMobile?'ml-4':'ml-16'">
                ...
                <dd class="mt-1">법무사의 과실 또는 부작위로 인한 법률상 배상책임액 및 사고처리 제비용 보상</dd>
              </dl>
            </li>
            <li :class="checkMobile.isMobile?'px-2 mt-2 mb-1':'px-16 mt-2 mb-1'">
              <div :class="checkMobile.isMobile?'pl-2 ml-2':'pl-16 ml-16'">
          ...
          <table class="normal-table">
            ...
            <tbody>
              ...
              <tr>
                <td class="border-right-0">협상권을 가진 보험중개사로서 계약자(대한법무사협회)를 대변하여 보험 계약 내용의 해석 및 사실 관계의 판단에 개입</td>
              </tr>
              <tr>
...
<script setup lang="ts">
  ...
  import V_TLAW0030P10 from '../contract/LAW/V_TLAW0030P10.vue';      // 보험료표
  import TermsOfPolicy from '../contract/LAW/V_TLAW0030P01.vue';      // PDF 다운로드 (약관)
  import TermsOfPolicy2 from '../contract/LAW/V_TLAW0030P04.vue';      // PDF 다운로드 (특별약관)
