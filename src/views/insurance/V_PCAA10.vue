        ...
        <v-col cols="12" sm="9" class="px-0 mt-12">
          ...
          <ul :class="checkMobile.isMobile?'list-style-type-none v-box py-2 px-2 mt-10 border-color-gray':'list-style-type-none v-box py-2 px-16 mt-10 border-color-gray'">
            <li class="d-flex justify-space-between align-center py-8">
              ...
              <p :class="checkMobile.isMobile?'text-h6 w-30 ml-4 mr-2':'text-h6 w-30 ml-10'">계약자<span class="text-18">(한국관세사회)</span> 대변</p>
        ...
        <v-col cols="12" md="10">
          <v-window v-model="tab2">
            <v-window-item value="option-1">
              <ul class="list-style-type-bull word-break-keep-all ml-3 text-16">
              ...
              <p class="color-gray-shadow mt-2 text-16">※ 관세 감면, 환급 신고 등의 부실신고로 인해 피해자가 추가로 부담하는 관세 차액은 “본세”에 해당하더라도 배상의 책임이 있을 수 있음.</p>
                ...
                <v-dialog persistent v-model="dialogCAAfaq" activator="parent" scrollable max-width="1000">
                  ...
                  <v-card>
                    ...
                    <v-card-text class="pa-0">
                      <iframe src="/assets/doc/CAA/관세사2025_예상질문에 대한 답변서.pdf" width="100%" height="800px"></iframe>
                    </v-card-text>
                  </v-card>
                </v-dialog>
              </v-btn>
              ...
              <div class="mt-4">
                ...
                <v-btn type="button" color="primary" variant="outlined" class="mt-2 d-block">
                  ...
                  <v-dialog persistent v-model="dialogERP" activator="parent" scrollable max-width="1000">
                    ...
                    <v-card>
                      <v-card-title class="d-flex justify-space-between align-center px-6 py-4 position-relative">
                        <p :class="checkMobile.isMobile?'text-h6 font-weight-bold text-12':'text-h6 font-weight-bold'">관세사배상책임보험 보고기간연장담보(ERP) 안내</p>
                        <v-spacer />
                      </v-card-title>
                      <v-divider class="mb-0"/>
