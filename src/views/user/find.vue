        ...
        <v-window v-model="tab1">
          ...
          <v-window-item value="tab1-one">
            <v-card-text v-if="isViewIDStep0">
              ...
              <h2 class="text-h5 font-weight-light" v-else-if="['ADV', 'LAW'].includes(businessCd)">개인회원 또는 복수가입회원을<br/>선택해 주세요.</h2>
              ...
              <div class="mt-10">
                ...
                <v-divider />
                <v-btn variant="text" @click="userDTO.user_cd = 'JNT'; fnFindIdCOR()" color="black" size="x-large" class="py-6 h-auto w-100 d-block" v-if="['ADV', 'CAA', 'PAT', 'LAW'].includes(businessCd)">
                  <div class="text-left font-weight-light w-100">
                    <p v-if="businessCd=='ADV' || businessCd=='LAW'">복수가입회원</p>
          ...
          <v-window-item value="tab1-two">
            ...
            <v-card-text v-if="isViewPWStep0">
              ...
              <div class="mt-10">
                ...
                <v-divider />
                <v-btn @click="userDTO.user_cd = 'JNT'; setViewPwStep(false, false, true, false);" variant="text" color="black" size="x-large" class="py-6 h-auto w-100 d-block" v-if="['ADV', 'CAA', 'PAT', 'LAW'].includes(businessCd)">
                  <div class="text-left font-weight-light w-100">
                    <p v-if="businessCd=='ADV' || businessCd=='LAW'">복수가입회원</p>
                    <p v-if="businessCd=='CAA'">합동사무소가입회원</p>
                    <p v-if="businessCd=='PAT'">합동가입회원</p>
            ...
            <v-card-text v-if="isViewPWStep2">
              ...
              <div class="mt-10">
                ...
                <template v-if="route.params.business_cd == 'ADV' || route.params.business_cd == 'LAW'">
                  <div class="d-flex align-center">
...
async function sendVerifyEMailCOR() {
  ...
  if (!userDTO.value.corp_bnno && businessCd === 'TAX') {
