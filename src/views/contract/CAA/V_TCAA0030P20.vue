      ...
      <v-card-text :hidden="checkMobile.isMobile&&isPdf" :class="isPdf?'pa-0':'py-6'">
        ...
        <div :class="isPdf?'d-none':''">
          <div id="printDiv">
            ...
            <!-- 복수 가입정보 시작 컨설팅 x 특약 x-->
            <div class="insuranceForm-wrap" v-if="['JNT','COR'].includes(insuranceDTO.user_cd) && insuranceDTO.cons_join_yn === 'N' && insuranceDTO.spct_join_yn === 'N'">
              <div :class="isPdf?'print-wrap':''">
                <!--header-->
                <header>
                  <h1 class="text-center">
            ...
            <!-- 복수 가입정보 컨설팅 o, 특약 x 시작-->
            <div class="insuranceForm-wrap" v-if="['JNT','COR'].includes(insuranceDTO.user_cd) && insuranceDTO.cons_join_yn === 'Y'  && insuranceDTO.spct_join_yn === 'N'">
              <div :class="isPdf?'print-wrap':''">
                <!--header-->
                <header>
                  <h1 class="text-center">
            ...
            <!-- 복수 가입정보 컨설팅 x 특약 o   시작-->
            <div class="insuranceForm-wrap" v-if="['JNT','COR'].includes(insuranceDTO.user_cd) && insuranceDTO.cons_join_yn === 'N'  && insuranceDTO.spct_join_yn === 'Y'">
              <div :class="isPdf?'print-wrap':''">
                <!--header-->
                <header>
                  <h1 class="text-center">
            ...
            <div class="insuranceForm-wrap" v-if="['JNT','COR'].includes(insuranceDTO.user_cd) && insuranceDTO.cons_join_yn === 'Y'  && insuranceDTO.spct_join_yn === 'Y'">
              <div :class="isPdf?'print-wrap':''">
                <!--header-->
                <header>
                  <h1 class="text-center">
...
const getCurrentChunkConsData = (chunkIndex) => {
  chunkIndex = chunkIndex - 1;
  const start = chunkIndex * chunkSize;
  const end = start + chunkSize;
...
onMounted(async () => {
  ...
  corpTypeItems.value = await CommonCode.getCodeList('COM051');
  ...
  if (props.insurance_uuid) {
    ...
    resultData.value = await apiCAA0030a.getDBSelHistory(params, isAdmin);
