            ...
            <div>
              <div class="print-wrap page1">
                ...
                <main>
                  ...
                  <h2 class="text-center mt-16 pt-8 text-34">법무사 배상책임보험<br />가입업체임을 증명함.</h2>
                  <p class="text-center mb-16 pb-8 text-28 color-red">{{ insuranceDTO.limited_collateral }}</p>
                  <p class="w-80 ma-auto word-break-keep-all text-18">귀 사(하)는 「법무사배상책임보험」에 가입하였으므로 상기 보험종목의 보상하는 손해로 인하여 타인에 대한 법률상배상책임이 발생한 경우 보험약관에 의거 당사가 이를 보상하여 드립니다.</p>
              ...
              <div class="print-wrap page2">
                <header class="position-relative">
                  <img src="../../../assets/images/d-join-logo.png" alt="" />
                  <h1 class="position-absolute text-center bottom-0 w-100 pb-3 color-white">법무사배상책임보험 가입조건 안내</h1>
                </header>
                <main>
                  <h2 class="title-wrap">
                  ...
                  <table class="table">
                    ...
                    <tr>
                      <th>피보험자</th>
                      <td colspan="3" v-if="insuranceDTO.user_cd === 'JNT' && insuranceDTO.cbr_data.length > 0">{{ insuranceDTO.cbr_data[0].cbr_nm }} 법무사 외 {{ insuranceDTO.cbr_cnt - 1 }} 명 </td>
                  ...
                  <table class="table" v-if="insuranceDTO.spct_join_yn === 'Y'">
                    ...
                    <tr>
                      ...
                      <td colspan="8" class="line-height-1-4">법무사배상책임보험(Lawyers Professional Liability Insurance)</td>
                    ...
                    <tr>
                      <td colspan="5">{{ insuranceDTO.insr_clm_lt_amt }} / {{ insuranceDTO.insr_year_clm_lt_amt }}</td>
                  ...
                  <table class="table" v-if="insuranceDTO.spct_join_yn !== 'Y'">
                    ...
                    <tr>
                      ...
                      <td colspan="12" class="line-height-1-4">법무사배상책임보험(Lawyers Professional Liability Insurance)</td>
                    </tr>
                    <tr>
                      <th colspan="2">증권번호</th>
                    ...
                    <tr>
                      <td class="text-left pl-8 py-2">
                        <ol class="list-style-type-demical">
                          <li> LawyersProfessional Liability Insurance Policy (Claims-made Basis) <br/>(법무사전문직업배상책임보험 보통약관 - 배상청구기준)</li>
