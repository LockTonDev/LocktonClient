    ...
    <v-card>
      ...
      <v-card-text :class="checkMobile.isMobile?'px-2 pt-4 pb-4':'px-10 pt-8 pb-14'">
        ...
        <div class="v-board-table mt-4 d-flex justify-space-between">
          <p :class="checkMobile.isMobile?'pa-2 pr-0 text-16':'pa-4 pr-0'">법무사전문인배상책임보험의 주요사항에 대해 록톤컴퍼니즈코리아로부터 충분히 설명 받고 양지하였음을 확인합니다.<br/> 설명 받았다는 사실을 “확인” 란에 체크 해주시기 바랍니다.</p>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  사무원의 부정직(또는 사기행위) 확장조항을 추가하지 않는 한, 보통약관의 담보조항에도 불구하고 ('선의의 피보험자'조항 등) 본 증권은 피보험자 또는 피보험자의 종업원에 의한 고의, 부정직, 악의, 범죄, 불법행위에 기인한 배상책임은 담보되지 않습니다.
                </td>
              </tr>
              <tr>
                <td class="text-center">7</td>
                <td>
                  <span class="font-weight-medium">* 사무원의 부정직(또는 사기행위)확장 조항(Dishonesty Extension):</span>
                  사무원의 부정직(또는 사기행위)확장조항을 추가 가입 할 경우, 피보험자의 고용인이 피보험자를 대신하여 전문서비스를 수행하는 동안 행한 부정직(또는 사기 행위)의 직접적인 결과로 보험기간 중에 인지된 금전적인 손실을 담보합니다. <span class="font-weight-bold" style="text-decoration: underline">사고가 인지(Discovery)된 이후 30일 이내에 해당 사실을 서면으로 보험회사에 통지해야 합니다.</span> 지방 법무사회에 등록된 전 사무원의 일괄가입을 전제로 하며, 법무사는 제외됩니다.
                </td>
              </tr>
              <tr>
        ...
        <p class="font-weight-medium mt-4 word-break-keep-all">보험약관은 당사 및 대한법무사협회 홈페이지에 게재되었으니 반드시 확인 및 양지하시기 바랍니다.</p>
