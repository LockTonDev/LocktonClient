<template>
                ...
                <v-row class="v-board-table">
                  ...
                  <v-col cols="12" sm="12" class="v-col">
                    ...
                    <div class="data-col w-100">
                      ...
                      <v-divider class="border-0" />
                      <!-- 법인인 경우 문구 표기 시작 -->
                      <p class="text-caption font-weight-light mt-2" v-if="insuranceDTO.user_cd === 'COR'">
            ...
            <v-row class="v-box-table">
              <v-col cols="12" class="px-16 py-10">
                ...
                >
                  ...
                  <li>
                    보험회사 : 현대해상화재보험㈜ <span class="text-caption mx-3">|</span>보험중개사 : 록톤컴퍼니즈코리아손해보험중개(주)
                  </li>
                  <li>
                    보험료 입금 계좌번호 :
  ...
  <v-dialog persistent v-model="isInsrTableDialog" width="1024" scrollable>
    <v-card class="position-relative">
      ...
      <v-card-text>
        <V_TTAX0030P10 :baseYear="insuranceDTO.insr_year"/>
      </v-card-text>
    </v-card>
  </v-dialog>
  ...
  <!-- 가입신청서 시작 -->
  <V_TTAX0030P20 :insurance_dto="insuranceDTO" :isPdf=isPdf v-if="isInsuranceFormDialog" @close="onInsuranceFormClose" />
  <!-- 가입증명서 종료 -->
...
import TermsOfPolicy from './V_TTAX0030P01.vue';       // PDF 다운로드로 대체 예정
