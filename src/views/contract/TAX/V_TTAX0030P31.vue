            ...
            <div class="certificate-font">
              <div class="print-wrap page1">
                ...
                <main>
                  ...
                  <h2 class="text-center mt-10 pt-4 text-34">세무사 배상책임보험<br />가입업체임을 증명함.</h2>
                  <p class="w-80 mt-10 pt-4 ma-auto word-break-keep-all text-18">귀 사(하)는 「세무사배상책임보험」에 가입하였으므로 상기 보험종목의 보상하는 손해로 인하여 타인에 대한 법률상배상책임이 발생한 경우 보험약관에 의거 당사가 이를 보상하여 드립니다.</p>
              ...
              <div class="print-wrap page2">
                ...
                <main>
                  ...
                  <table class="table">
                    ...
                    <tr>
                      <th colspan="5" style="border-right: 1px solid #000;">주소</th>
                  ...
                  <table class="table" v-if="insuranceDTO.spct_join_yn === 'Y'">
                    ...
                    <tr>
                      ...
                      <td colspan="25" class="line-height-1-4" style="border-top: 1px solid #00B050;">세무사배상책임보험(Miscellaneous Professional Liability Insurance Policy)</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                      <td colspan="10" style="border-right: 1px solid #000;">{{ insuranceDTO.insr_clm_lt_amt.getValueBySplit(1)  }} / {{ insuranceDTO.insr_year_clm_lt_amt }}</td>
                    ...
                    <tr>
                      <td class="text-left pl-8 py-2">
                        <ol class="list-style-type-demical">
                          ...
                          <li> Damage to property under ongoing professional work excluded (전문업무수행 중 재물 손해 제외) </li>
                          <li> All Costs & Expenses are included within the L.O.L. (모든 비용은 보상한도액 내 포함)  </li>
                          <li> War, Civil War, Political Risk and Terrorism  Exclusion Clause (전쟁, 내란, 정치적 위험 및 테러 부담보 조항)  </li>
                          <li> Premium/Claim Payment Clause (환율적용 특별약관) </li>
                          <li> Communicable Disease Exclusion (전염병 부담보 특별약관) </li>
                        </ol>
                      </td>
                    </tr>
                  </table>
