    ...
    <v-card>
      ...
      <v-card-text :class="checkMobile.isMobile?'px-2 pt-4 pb-4':'px-10 pt-8 pb-14'">
        ...
        <div class="v-board-table mt-4 d-flex justify-space-between">
          <p :class="checkMobile.isMobile?'pa-2 pr-0 text-16':'pa-4 pr-0'">변리사전문인배상책임보험의 주요사항에 대해 록톤컴퍼니즈코리아로부터 충분히 설명 받고 양지하였음을 확인합니다.<br/> 설명 받았다는 사실을 “확인” 란에 체크 해주시기 바랍니다.</p>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  업무수행 과정이나 그러한 목적으로 소유, 사용, 관리하는 "기술정보"의 우연한 "유출"로 기인한 피보험자의 법률상 손해배상책임을 보상합니다. <br/>
