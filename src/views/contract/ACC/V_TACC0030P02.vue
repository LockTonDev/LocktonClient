    ...
    <v-card>
      <v-card-title class="d-flex align-center justify-space-between">
          <div class="text-h6 font-weight-medium text-wrap">
            회계사전문인배상책임보험 상품설명 확인서 <span class="text-18">(피보험자 회계사 확인)</span>
          </div>
      </v-card-title>   
      ...
      <v-card-text :class="checkMobile.isMobile?'px-2 pt-4 pb-4':'px-10 pt-8 pb-14'">
        <ul class="list-style-type-none font-weight-medium">
          <li>보험계약자	:	한국공인회계사 감사반연합회 </li>
        </ul>
        <div class="v-board-table mt-4 d-flex justify-space-between">
          <p :class="checkMobile.isMobile?'pa-2 pr-0 text-16':'pa-4 pr-0'">회계사전문인배상책임보험의 주요사항에 대해 록톤컴퍼니즈코리아로부터 충분히 설명 받고 양지하였음을 확인합니다.<br/> 설명 받았다는 사실을 “확인” 란에 체크 해주시기 바랍니다.</p>
          ...
          <table class="w-100">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  <span class="font-weight-medium">* 공동부담비율:</span> 
                  1회의 배상청구에 대하여 손해사정 후 결정된 손해배상금에서 자기부담금을 차감한 금액(=예상 지급보험금)의 일정비율(%)에 해당하는 금액을 피보험자가 부담하는 제도입니다. (예상지급보험금에는 방어비용 및 조사비가 포함)
                </td>
              </tr>
              <tr>
        ...
        <p class="font-weight-medium mt-4 word-break-keep-all">보험약관은 당사 홈페이지 보장사항 및 알림마당에 게재되었으니 반드시 확인 및 양지하시기 바랍니다.</p>
