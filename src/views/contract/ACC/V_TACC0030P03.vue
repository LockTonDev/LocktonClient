    ...
    <v-card>
      <v-card-title class="d-flex align-center justify-space-between">
        <div class="text-h6 font-weight-medium text-wrap">
          계약의 체결∙이행 등을 위한 개인(신용)정보 처리 동의서 (공인회계사)
        </div>
      ...
      <v-card-text :class="checkMobile.isMobile?'px-2 pt-4 pb-4':'px-10 pt-8 pb-14'">
        <div class="d-flex justify-space-between align-center">
          <h3 :class="checkMobile.isMobile?'text-20 text-display-2 font-weight-bold':'text-display-2 font-weight-bold'">DB손해보험주식회사 귀중</h3>
              ...
              <ul>
                ...
                <li>▪ 개인(신용)정보를 제공받는 자의 이용목적
                  <ul>
                    ...
                    <li>∙한국공인회계사 감사반연합회, 한국공인회계사회 : 단체보험 가입∙운영, 보험갱신, 사고조회, 자문업무</li>
                  </ul>
                </li>
                <li>▪ 제공할 개인(신용)정보의 내용
                  <ul>
