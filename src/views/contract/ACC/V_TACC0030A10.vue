<template>
  ...
  <v-row>
    <v-col cols="12">
      <dl class="mt-16 pa-10 bg-background">
        ...
        <dd class="text-body-2 mt-2">&middot; 계약 해지는 변경페이지에서 신청 후 02-2011-0300 으로 연락 주시기 바랍니다.</dd>
      </dl>
    </v-col>
  </v-row>
  ...
  <!-- 가입신청서 시작 -->
  <V_TACC0030P20 :insurance_uuid="insuranceUUID" :isPdf=true v-if="isInsuranceFormDialog" @close="onInsuranceFormClose" />
  <!-- 가입증명서 종료 -->

  <!-- 가입증명서 시작 -->
  <V_TACC0030P30 :insurance_uuid="insuranceUUID" :isPdf=true v-if="isCertificatePrintFramDialog" @close="onCertificatePrintFrameClose" />
  <!-- 가입증명서 종료 -->
