...
router.beforeEach(async function (to, from, next) {
 ...
 /* const isMobile = /android|webos|iphone|ipad|ipod|blackberry|iemobile|opera mini/i.test(navigator.userAgent || navigator.vendor || window.opera);
  ...
  const userPages = ['/', '/error', '/device/mobile', '/introduce', '/user/login',
    ...
    '/user/find/CAA', '/user/find/PAT', '/user/find/LAW',
    '/user/register/CAA', '/user/register/TAX', '/user/register/ACC',
    '/user/register/PAT', '/user/register/ADV', '/user/register/LAW'];
  ...
  if (to.path.indexOf('/lcksl-fr/lypts/sol01') !== -1) {
    ...
    try {
      ...
      // const allowedIPs = ['110.9.11.206','121.137.148.62', '110.35.173.2','183.109.121.132','222.233.19.63'];
        const allowedIPs = ['110.9.11.206', '110.35.173.2', '210.91.70.141','210.176.70.84','218.189.87.28'];
