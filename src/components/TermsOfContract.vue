  ...
  <v-dialog persistent v-model="isOpenDialog" width="1000px" hide-overlay scrollable>
      <v-card>
          <v-card-title class="d-flex align-center justify-space-between">
              <div class="text-h6 font-weight-medium text-wrap">
                 계약의 체결∙이행 등을 위한 개인(신용)정보 처리 동의서 (관세사)
              </div>
      ...
      <v-divider class="mb-0"/>
        ...
        <div class="d-flex justify-space-between align-center">
          <h3 :class="checkMobile.isMobile?'text-20 text-display-2 font-weight-bold':'text-display-2 font-weight-bold'">메리츠화재해상보험주식회사 귀중</h3>
            ...
            <tbody>
              <tr>
                ...
                <td colspan="2">
                  ...
                  <p>정보동의시 당사 및 당사 업무수탁자는 계약의 체결 및 이행 목적달성에 부합하는 최소한의 정보만 수집∙이용 및 제공하며, 귀하는 동의를 거부할 권리가 있습니다. 단, 본 동의를 거부하시는 경우에는 보험계약의 체결이 부득이하게 거절되거나 정상적인 서비스 제공이 불가능할 수 있음을 알려 드립니다.</p>
              ...
              <tr>
                ...
                <td>
                  당사 및 당사 업무수탁자는「개인정보보호법」및 「신용정보의 이용 및 보호에 관한 법률」에 따라 본 계약과 관련하여 귀하의 개인(신용)정보를 다음과 같이 수집∙이용하고자 합니다. 이에 대하여 동의하십니까?
                </td>
                <td class="px-0">
                  <v-checkbox v-model="agr_yn.agr31_yn" true-value="Y" false-value="N" hide-details label="동의함" :disabled="isReadonly"/>
                </td>
              </tr>
              <tr>
                <th>
                ...
                <td>
                  당사 및 당사 업무수탁자는「신용정보의 이용 및 보호에 관한 법률」에 따라 본 계약과 관련하여 귀하의 개인(신용)정보를 다음과 같이 신용정보집중기관 및 보험요율산출기관 으로부터 조회하고자 합니다. 이에 대하여 동의하십니까? 
                </td>
                <td class="px-0">
                  <v-checkbox v-model="agr_yn.agr32_yn" true-value="Y" false-value="N" hide-details label="동의함" :disabled="isReadonly"/>
                </td>
              </tr>
              <tr>
                <th>
                ...
                <td>
                  당사 및 당사 업무수탁자는「개인정보보호법」및「신용정보의 이용 및 보호에 관한 법률」에 따라 본 계약 관련한 귀하의 개인(신용)정보를 다음과 같이 제3자에게 제공하고자 합니다. 이에 대해 동의하십니까?
                </td>
                <td class="px-0">
                  <v-checkbox v-model="agr_yn.agr33_yn" true-value="Y" false-value="N" hide-details label="동의함" :disabled="isReadonly"/>
                </td>
              </tr>
              <tr>
                <th>
                ...
                <td>
                  당사 및 당사 업무수탁자는「개인정보보호법」제24조에 따라 본 계약과 관련하여 상기의 개인(신용)정보에 대한 개별 동의 사항에 대하여 귀하의 고유식별정보(주민등록번호∙외국인등록번호)를 처리(수집∙이용, 제공 등)하고자 합니다. 이에 대하여 동의 하십니까?
                </td>
                <td class="px-0">
                  <v-checkbox v-model="agr_yn.agr34_yn" true-value="Y" false-value="N" hide-details label="동의함" :disabled="isReadonly"/>
                </td>
              </tr>
            </tbody>
          </table>
        ...
        <div class="border-top-black-1 border-bottom-lightgray-1 py-4 terms-wrap-v1 mt-4">
              ...
              <li>1.개인(신용)정보의 수집∙이용에 관한 동의 사항
                  <ul>
                      <li>▪ 개인(신용)정보의 수집∙이용 목적
                          <ul>
                              <li>∙보험계약의 인수심사∙체결∙유지∙관리(부활 및 갱신 포함), 보험금 등 지급∙심사, 순보험요율의 산출∙검증, 민원처리 및 분쟁 대응, 적부 및 보험사고조사(보험사기 조사 포함), 보험모집질서 유지,조사연구,서비스제공</li>
                          </ul>
                      </li>
                  ...
                  <ul>
                      ...
                      <li>▪ 개인(신용)정보를 제공받는 자의 이용목적
                          <ul>
                              ...
                              <li>∙한국관세사회 : 단체보험 가입∙운영, 보험갱신, 사고조회, 자문업무</li>
                          </ul>
                      </li>
                      <li>▪ 제공할 개인(신용)정보의 내용
                          <ul>
            ...
            <p>※각 제공대상기관 및 이용목적의 구체적인 정보는 당사 홈페이지[http://www.meritzfire.com]에서 확인할 수 있습니다.</p>
        </div>
        <p class="font-weight-medium mt-4 word-break-keep-all">※ 본인은 「개인정보보호법」및 「신용정보의 이용 및 보호에 관한 법률」에 따라 귀사가 본인의 개인(신용)정보를 상기 내용과 같이 처리하는 것에 동의 합니다.</p>
      </v-card-text>
      </v-card>
  </v-dialog>
